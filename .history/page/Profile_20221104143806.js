      ...
      <View style={styles.main}>
        <View style={styles.block}>
          ...
          <View style={styles.item}>
            ...
            <FontAwesome5 name="chevron-right" size={15} color="black" style={styles.iconChevron} />
          </View>
        </View>
        <View style={styles.block}>
          ...
          <View style={styles.item}>
            ...
            <FontAwesome5 name="chevron-right" size={15} color="black" style={styles.iconChevron1} />
          </View>
        </View>
        <View style={styles.block}>
          ...
          <View style={styles.item}>
            ...
            <FontAwesome5 name="chevron-right" size={15} color="black" style={styles.iconChevron2} />
          </View>
        </View>
        <View style={styles.block}>
          ...
          <View style={styles.item}>
            ...
            <FontAwesome5 name="chevron-right" size={15} color="black" style={styles.iconChevron3} />
          </View>
        </View>
        <View style={styles.block}>
          <FontAwesome5 name="question-circle" size={20} style={styles.iconHome} />
          <View style={styles.item}>
            <Text style={styles.text3}>Faq</Text>
            <FontAwesome5 name="chevron-right" size={15} color="black" style={styles.iconChevron4} />
          </View>
        </View>
        <View style={styles.block}>
          ...
          <View style={styles.item}>
            ...
            <FontAwesome5 name="chevron-right" size={15} color="black" style={styles.iconChevron5} />
          </View>
        </View>
        <View style={styles.block}>
          <FontAwesome5 name="cog" size={20} style={styles.iconHome} />
          <View style={styles.item}>
            ...
            <FontAwesome5 name="chevron-right" size={15} color="black" style={styles.iconChevron6} />
          </View>
        </View>
      </View>
    </View>
